...
<>
 ...
 data?.customerDetails?.amcType !== "AMC Assured" && 
   ...
   Assured AMC Premium Amount: INR <span style={{ textDecoration: "underline" }}>{(parseFloat(data.vehicleDetails.total)).toFixed(2) - (parseFloat(data.vehicleDetails.total) / 1.3)}</span> (Refundable only if Raam is unable to match the price offered to you in the market before selling the vehicle, and Raam is unable or unwilling to match the offer within the Agreement Period).</p>}
       {
         data?.customerDetails?.amcType !== "AMC Assured" ?
