...
<>
 ...
 data?.customerDetails?.amcType !== "AMC Assured" && 
   ...
   <p> <br />AMC Amount: INR <span style={{ textDecoration: "underline" }}>{(parseFloat(data?.vehicleDetails?.total) / 1.3).toFixed(2)}</span> (Refundable only if the vehicle is sold to Raam within the Agreement Period) <br />  <br />
