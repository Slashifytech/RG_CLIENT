...
const EwPdf = forwardRef(({ id }, ref) => {
  ...
  return (
    <div ref={pdfRef} className={` bg-white p-6 border  shadow-md `}>
      ...
      <div
        className={`${location.pathname === "/ew-view" ? "mt-6 " : "mt-[10%]"}`}
      >
        <img
          src={pdfHeaderOne}
          alt="header"
      ...
      >
        ...
        <span className="flex-1 ml-3 border border-gray-400 p-1 bg-blue-100 h-9 mt-3">
      ...
      >
            ...
            <span>
              <div className="p-4">
                <h3 className="flex items-start space-x-2 text-lg font-semibold ">
                  ...
                  <span>
                    What are the steps that I should follow to keep my warranty
                    benefits intact?
                  </span>
                </h3>
                <ul className="mt-2 space-y-2">
                  ...
                  <li>
                    ☑ Preserve all the documents of services for future concerns
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4">
                <h3 className="flex items-start space-x-2 text-lg font-semibold ">
                  ...
                  <span>
                    What are common reasons of claim rejections and how to avoid
                    mistakes during claims?
                  </span>
                </h3>
                <ul className="mt-2 space-y-2">
                  <li>
                  ...
                  <li>
                    ...
                    in case of black smoke or oil leakage through any component
                    and if the vehicle is driven in spite of warnings then there
                    are high chances of other parts getting damaged) and such
                    related losses are not covered.
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4">
                <h3 className="flex items-start space-x-2 text-lg font-semibold ">
                  ...
                  <span>
                    Is periodic service like changing oil, filters etc. covered
                    under this policy?
                  </span>
                </h3>
                <ul className="mt-2 space-y-2">
              ...
              <div className="p-4">
                <h3 className="flex items-start space-x-2 text-lg font-semibold ">
                  ...
                  <span>
                    My policy has an error and I need to rectify the same, whom
                    do I contact to get it done?
                  </span>
                </h3>
                <ul className="mt-2 space-y-2">
                  <li>
                    ☑ There is one way to get it done, however this needs to be
                    done within 15 days from the date of issuance of the policy.
                    An email needs to be written along with the policy document
                    to ew@mghyderabad.com
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4">
                ...
                <ul className="mt-2 space-y-2">
                  <li>
                    ☑ Yes, however the new owner needs to contact us to get the
                    details changed on the policy within 15 days of transfer of
                    ownership of vehicle. How
                  </li>
                </ul>
              </div>
            </span>
              ...
              <div className="p-4 ">
                ...
                <ul className="mt-2 space-y-2">
                  <li>
                    ...
                    canceled within 15 days of the issuance. This is called free
                    look up period. Refund is applicable in case there is no
        ...
        <div className="mt-9">
          ...
          <div className="p-6 ">
            ...
            <div className="p-4 text-gray-900 space-y-4">
              <div>
                <h3 className="font-bold text-blue-500">(A) COVERAGE BASIS</h3>
                <p>
              ...
              <div>
                ...
                <ul className="list-disc list-inside">
                  <li>
                    Towing service to the nearest authorized service center (as
                    per policy terms).
                  </li>
                  <li>
                    Onsite repair assistance for minor issues, including battery
                    jump-start, tire replacement, and minor repairs.
                  </li>
                </ul>
              </div>
              <div>
            ...
            <div className="p-4 text-gray-900 space-y-4">
              <div>
                ...
                <p>
                  Jump-start service provided if the vehicle is immobilized due
                  to a flat battery within 100 km from the city center of the
                  owner's residence.
                </p>
              </div>
              <div>
              ...
              <div>
                ...
                <p>
                  ...
                  make the vehicle mobile again if it breaks down within 100 km
              ...
              <div>
                ...
                <p>
                  ...
                  nearest preferred workshop within 100 km from the city center.
                </p>
              </div>
              <div>
          ...
          <div>
            ...
            <p>
              {" "}
              <b>a. Ownership Transfer:</b> Roadside assistance benefits expire
              upon the transfer of vehicle ownership.{" "}
            </p>
            <p>
              {" "}
        ...
        <div className="p-6 ">
          ...
          <div className="p-4 text-gray-900 space-y-2">
            ...
            <ul className="list-disc list-inside space-y-1">
              ...
              <li>
                Damage due to accidents where the vehicle is still operational.
              </li>
              <li>
                Issues caused by neglecting periodic maintenance or servicing at
                unauthorized workshops.
              </li>
              <li>
                Breakdowns due to overloading, misuse, or exceeding manufacturer
                limits.
              </li>
              <li>
              ...
              <li>
                Minor inconveniences like noises, vibrations, or normal wear and
                tear.
              </li>
              <li>
              ...
              <li>
                Routine maintenance tasks like oil changes, wheel balancing, or
                AC servicing.
              </li>
              <li>
        ...
        <div className="p-6 text-gray-900 space-y-2">
          ...
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>
              Mechanical/electrical failures due to overheating, short circuits,
              or lack of proper tools/spares.
            </li>
            <li>
            ...
            <li>Repairs for parts still under the manufacturer’s warranty.</li>
            <li>
            ...
            <li>
              Wear-and-tear on external parts, paint, upholstery, or damage from
              environmental factors.
            </li>
            <li>
              Repairs for entertainment, navigation, or control systems (audio,
              video, electronics).
            </li>
            <li>Failures of non-covered parts affecting covered components.</li>
            <li>
              Routine maintenance jobs such as cleaning, polishing, fluid
              changes, tuning, and alignment.
            </li>
            <li>
              Non-maintenance issues due to lack of care, including spark plugs,
              brake pads, filters, belts, hose, seats, batteries, tires, and
              glass components.
            </li>
            <li>
              Routine replacement of fluids, oils, coolants, AC gas, and grease,
              except when required for a covered repair.
            </li>
            <li>
            ...
            <li>
              Failures caused by water entry, turbocharger, or differential due
              to hydrostatic lock or oil starvation.
            </li>
            <li>Losses caused by poor workmanship.</li>
            <li>Claims made after the policy limit has expired.</li>
            <li>
              Any consequential damage, third-party liability, personal injury,
              or property damage.
            </li>
            <li>
        ...
        <div className="bg-blue-900 text-white font-bold p-2 rounded pb-4">
          <span className="-mt-3">5. GENERAL CONDITIONS</span>
        </div>{" "}
        ...
        <div className="bg-blue-900 text-white font-bold p-2 rounded mt-12 pb-4">
          <span className="-mt-3">6. CUSTOMER SUPPORT</span>
        </div>
        <ul className=" list-inside space-y-1 my-4">
          <li>
            For complaints or queries, contact the customer service team at 1800
            209 8383.
          </li>
        </ul>
